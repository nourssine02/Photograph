...
class getCartServiceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Service\\Cart\\CartService'] = new \App\Service\Cart\CartService(($container->services['session'] ?? $container->load('getSessionService')), ($container->privates['App\\Repository\\PanierRepository'] ?? $container->load('getPanierRepositoryService')));
    }
}
