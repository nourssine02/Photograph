...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', 'confirm_password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'commandes', '' . "\0" . 'App\\Entity\\User' . "\0" . 'favoris'];
        }
    ...
    public function getConfirm_password()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConfirm_password', []);

        return parent::getConfirm_password();
    }
    ...
    public function setConfirm_password($confirm_password)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setConfirm_password', [$confirm_password]);

        return parent::setConfirm_password($confirm_password);
    }
